...
/**
 * Provides the methods to execute your app backend services by making http request to your app version endpoints.
 *
 * If your endpoints require a **Session** token, you can also set it in two ways either calling the {@link AuthManager.setSession} method with a valid session object or as an input header with the name **Session** (e.g., Session: \<your session token\>) in specific methods.
 * @export
